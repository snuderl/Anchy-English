...
def fix_family_exercises():
    with app.app_context():
        ...
        Exercise.query.filter_by(exercise_set_id=family_set.id).delete()
        ...
        for ex_data in new_exercises:
            exercise = Exercise(
                ...
                missing_word=ex_data["missing_word"],
                slovene_hint=ex_data["slovene_hint"],
                difficulty_level=ex_data["difficulty_level"],
                exercise_set_id=family_set.id,
            )
