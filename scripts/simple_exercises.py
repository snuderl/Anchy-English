...
def create_simple_exercises():
    with app.app_context():
        ...
        print(
            f"Successfully created 3 exercise sets with {total_exercises} total exercises:"
        )
