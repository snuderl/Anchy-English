...
config(['$routeProvider', function($routeProvider) {
  $routeProvider.when('/worksheets/new', {templateUrl: 'partials/partial1.html', controller: 'MyCtrl1'});
  $routeProvider.when('/worksheets/:id', {templateUrl: 'partials/partial1.html', controller: 'MyCtrl1'});
  $routeProvider.when('/worksheets', {templateUrl: 'partials/partial2.html', controller: 'MyCtrl2'});
  $routeProvider.when('/categories', {templateUrl: 'partials/partial3.html', controller: 'MyCtrl3'});
